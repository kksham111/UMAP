...
def parse_args():
    ...
    parser.add_argument("--out_name", type=str, default="result", help="Output file name")
...
if __name__ == "__main__":
    ...
    with amp_ctx:
        ...
        np.savez(os.path.join(out_dir, f'result_{args.out_name}.npz'), **data_npz_load)

        print(f"Results saved to {out_dir}.\nTo visualize them with tapip3d, run: [bold yellow]python tapip3d_viz.py {out_dir}/result_{args.out_name}.npz[/bold yellow]")
